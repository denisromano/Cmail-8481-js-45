...
var LoginInputDTO = /** @class */ (function () {
    ...
    LoginInputDTO.ctorParameters = function () { return [
        null
    ]; };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(service, roteador) {
    ...
    LoginComponent.prototype.handleLogin = function () {
        ...
        if (this.formLogin.valid) {
            var loginDTO = new src_app_models_dto_LoginInputDTO__WEBPACK_IMPORTED_MODULE_4__["LoginInputDTO"](this.formLogin.value);
            ...
            this.service.autenticar(this.formLogin.value)
                ...
                _this.roteador.navigate(['']);
            }, function (erro) {
                _this.mensagem = erro.error;
                console.error(erro);
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.autenticar = function (loginData) {
        var loginDTO = {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resposta) {
