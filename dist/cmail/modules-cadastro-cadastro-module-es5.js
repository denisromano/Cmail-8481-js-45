...
var UserInputDTO = /** @class */ (function () {
    function UserInputDTO(_a) {
        var nome = _a.nome, username = _a.username, telefone = _a.telefone, senha = _a.senha, avatar = _a.avatar;
        this.name = "";
        this.username = "";
        this.phone = "";
        this.password = "";
    ...
    UserInputDTO.ctorParameters = function () { return [
        null
    ]; };
    return UserInputDTO;
}());
...
var CadastroRoutingModule = /** @class */ (function () {
...
var CadastroComponent = /** @class */ (function () {
    function CadastroComponent(httpRequest, service, roteador) {
    ...
    CadastroComponent.prototype.validaImagem = function (campo) {
        var erroValidacao = {
            urlInvalida: true
        };
        return this.httpRequest.head(campo.value, {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (resposta) {
            var contentType = resposta.headers.get('Content-Type');
    ...
    CadastroComponent.prototype.handleCadastro = function () {
        ...
        this.service.cadastrar(this.formCadastro.value)
            ...
            _this.mensagem = "Cadastro feito com sucesso!!!";
            _this.formCadastro.reset();
        }, function (erro) {
            _this.mensagem = erro.error.body[0].message;
        }, function () {
            setTimeout(function () {
                _this.roteador.navigate(['login']);
            }, 3000);
        });
    };
...
var CadastroService = /** @class */ (function () {
    ...
    CadastroService.prototype.cadastrar = function (cadastroData) {
        var userInputDTO = new _models_dto_UserInputDTO__WEBPACK_IMPORTED_MODULE_3__["UserInputDTO"](cadastroData);
        return this.http
...
//# sourceMappingURL=modules-cadastro-cadastro-module-es5.js.map