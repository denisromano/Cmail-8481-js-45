 ...
 * @type {?}
 */
const VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('8.2.6');
...
let CmailListItemComponent = class CmailListItemComponent {
    constructor() {
        this.destinatario = '';
        this.assunto = '';
        this.conteudo = '';
...
let FormFieldDirective = class FormFieldDirective {
    constructor(referenciaDoElemento) {
        this.referenciaDoElemento = referenciaDoElemento;
    }
    ngOnInit() {
        const campo = this.referenciaDoElemento.nativeElement;
        if (!campo.name) {
...
//# sourceMappingURL=default~modules-cadastro-cadastro-module~modules-caixa-de-entrada-caixa-de-entrada-module~modules-lo~61474138-es2015.js.map